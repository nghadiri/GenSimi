...
COPY admissions FROM 'C:\C\Data\mimiciii\csv\ADMISSIONS.csv' DELIMITER ',' CSV HEADER;
...
COPY labevents FROM 'C:\C\Data\mimiciii\csv\LABEVENTS.csv' DELIMITER ',' CSV HEADER;
...
COPY noteevents FROM 'C:\C\Data\mimiciii\csv\NOTEEVENTS.csv' DELIMITER ',' CSV HEADER;
...
COPY patients FROM 'C:\C\Data\mimiciii\csv\PATIENTS.csv' DELIMITER ',' CSV HEADER;
...
COPY prescriptions FROM 'C:\C\Data\mimiciii\csv\PRESCRIPTIONS.csv' DELIMITER ',' CSV HEADER;
...
COPY PROCEDURES_ICD FROM 'C:\C\Data\mimiciii\csv\PROCEDURES_ICD.csv' DELIMITER ',' CSV HEADER;
