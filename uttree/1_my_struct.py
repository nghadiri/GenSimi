...
Original file is located at
    https://colab.research.google.com/drive/1GELwaf63OqHoDHXKRAlwZ-kLmRUnMJSM
...
#data=data[['subject_id',	'hadm_id','starttime',	'stoptime', 'drug_type', 'drug']]
#data=data[['SUBJECT_ID',	'HADM_ID','STARTDATE',	'ENDDATE', 'DRUG_TYPE', 'DRUG_NAME_GENERIC']]

#data.head()

#num_nan_hadm_ids = data['hadm_id'].isna().sum()
#num_nan_hadm_ids

#data['startdate'].isna().sum()

#data['enddate'].isna().sum()
...
#data['startdate']=pd.to_datetime(data['starttime']).dt.date
#data['enddate']=pd.to_datetime(data['stoptime']).dt.date

#data=data[data['hadm_id']==159647]
#data=data[data['hadm_id']==20626031]
